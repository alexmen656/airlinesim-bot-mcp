                ...
                body:
                    JSON.stringify({
                        ...
                        `
                            ...
                            {
                                role: "system",
                                content: `You are the CEO of ${this.airlineName}, a Airline based at ${this.hub} Airport (main hub) in a Airline Simulator Game, your goal is to build the most profitable airline ever`
                            },
                            {
                                role: "user",
