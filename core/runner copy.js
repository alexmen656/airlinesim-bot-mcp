        ...
        body:
            JSON.stringify({
                ...
                messages: [
                    ...
                    {
                        role: "system",
                        content: "You are the CEO of Summit Air, a Airline based at DFW (Dallas Internationl Airport, USA) Airport (main hub) in a Airline Simulator Game, your goal is to build the most profitable airline ever"
                    },
                    {
                        role: "user",//system
